...
- 当前里程碑：M9 科研汇报与真实 PPTX
- 当前状态：M9_COMPLETE_WAITING_FOR_REVIEW
- 活动工程：`site/`（唯一活动工程）
...
- 当前批次：M9 真实 PPTX、版本、来源、讲者备注、问答和打开验证已完成；下一里程碑 M10
...
- M8.4：DONE — 机制图、理论框架、研究流程、Graphical Abstract、科研信息图的受控 SVG 渲染与版本追溯。
...
- 尚未进入 M10 发布候选或 M11 部署。
- M9：DONE — 13 场景、不可变 PresentationVersion、真实 PPTX、图件绑定、notes/来源、问答准备和打开验证。
